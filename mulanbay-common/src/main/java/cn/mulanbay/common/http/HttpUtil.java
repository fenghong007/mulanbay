 ...
 *
 * @author fenghong
 * @create 2017-10-11 17:17
 **/
public class HttpUtil {

    private static HttpApiLogProcessor logProcessor;

    private static Logger s_log = Logger.getLogger(HttpUtil.class);
        ...
        if(selfClient){
            if(client!=null){
                try {
                    ...
                    s_log.error("client.close error:",e);
                }
            }
        }
    }
