...
public class CommandUtil {
	...
	public static String executeLinuxCmd(String cmd) {
		...
		try {
			...
			throw new ApplicationException(ErrorCode.EXCUTE_CMD_ERROR, "执行命令"
	 ...
	 * @return
	 */
	public static String executeCmd(int osType, String cmd) {
		if (osType == OSType.Linux.getValue()) {
			return executeLinuxCmd(cmd);
		} else if (osType == OSType.Windows.getValue()) {
			return executeWindowsCmd(cmd);
		} else if (osType == OSType.Unknown.getValue()) {
			// 获得系统属性集
