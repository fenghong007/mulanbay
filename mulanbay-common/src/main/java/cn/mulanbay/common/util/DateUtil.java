...
public class DateUtil {
	 ...
	 * @return
	 */
	public static String getFormMiddleNight() {
		return getToday(FormatDay1)+ " 00:00:00";
	}
	
	public static Date getFormMiddleNightDate(String date){
		return getDate(date+" 00:00:00",Format24Datetime);
	}

	public static Date getFormMiddleNightDate(Date date){
	 ...
	 * @return
	 */
	public static boolean checkTimeAllow(String timePeriods){
		if(StringUtil.isEmpty(timePeriods)){
			return true;
		}else{
			String today = DateUtil.getToday();
			Date now = new Date();
			for(String s : timePeriods.split(",")){
				String[] hms = s.split("-");
