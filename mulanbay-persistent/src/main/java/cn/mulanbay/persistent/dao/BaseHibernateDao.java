...
public class BaseHibernateDao {
	 ...
	 * @throws BaseException
	 */
	protected void removeEntitys(String HQL) throws BaseException {
		if(logger.isDebugEnabled()){
			logger.debug("removeEntitys HQL:" + HQL);
		}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	protected void removeEntitys(Collection objs) throws BaseException {
		if(logger.isDebugEnabled()){
	 ...
	 * @throws BaseException
	 */
	protected void saveEntitys(Object objs[]) throws BaseException {
		if(logger.isDebugEnabled()){
			logger.debug("saveEntitys objs[]:" + JsonUtil.beanToJson(objs));
		}
		if (objs == null) {
			throw new BaseException("保存失败，持久化对象为空！");
		}
	 ...
	 * @throws BaseException
	 */
	protected void saveAndUpdateEntitys(Object saveAndUpdate[])
			throws BaseException {
		try {
			if(logger.isDebugEnabled()){
				logger.debug("saveAndUpdateEntitys objs[]:" + JsonUtil.beanToJson(saveAndUpdate));
			}
	 ...
	 * @throws BaseException
	 */
	protected void updateEntitys(Object objs[]) throws BaseException {
		if(logger.isDebugEnabled()){
			logger.debug("updateEntitys objs:" + JsonUtil.beanToJson(objs));
		}
		if (objs == null) {
			throw new BaseException("持久化对象为空！");
		}
	 ...
	 * @throws BaseException
	 */
	protected void updateEntitys(String hql, Object... objects)
			throws BaseException {
		try {
			if(logger.isDebugEnabled()){
