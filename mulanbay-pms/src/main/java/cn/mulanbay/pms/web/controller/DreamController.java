...
import cn.mulanbay.pms.web.bean.request.dream.DreamFormRequest;
import cn.mulanbay.pms.web.bean.request.dream.DreamSearch;
import cn.mulanbay.pms.web.bean.request.dream.DreamStatListSearch;
import cn.mulanbay.pms.web.bean.request.dream.DreamStatSearch;
...
public class DreamController  extends BaseController {
    ...
    @ResponseBody
    public ResultBean getData(DreamSearch sf,@RequestParam(value = "statuses[]",required = false) List<DreamStatus> statuses) {
    ...
    @ResponseBody
    public ResultBean create(@Valid DreamFormRequest formRequest) {
    ...
    @ResponseBody
    public ResultBean edit(@Valid DreamFormRequest formRequest) {
    ...
    @RequestMapping(value = "/dreamStatList")
    public String dreamStatList() {
        return "dream/dreamStatList";
    }
