...
public class ReadingRecordAnalyseStatSearch extends QueryBulider implements DateStatSearch ,BindUser,FullEndDateTime {
	...
	public enum GroupType{
		BOOKCATEGORY("book_category_id"),BOOKTYPE("book_type"),LANGUAGE("language"),
		IMPORTANTLEVEL("important_level"),STATUS("status"),PUBLISHEDYEAR("published_year"),PRESS("press"),
		NATION("nation");
