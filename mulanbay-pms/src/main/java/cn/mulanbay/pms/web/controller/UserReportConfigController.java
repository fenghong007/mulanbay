...
public class UserReportConfigController extends BaseController {
    ...
    public String list() {
        return "report/userReportConfigList";
    }
    ...
    @ResponseBody
    public ResultBean create(@Valid UserReportConfigFormRequest formRequest ) {
    ...
    public ResultBean get(@Valid CommonBeanGetRequest getRequest) {
        UserReportConfig bean=this.getUserEntity(UserReportConfig.class,getRequest.getId(),getRequest.getUserId());
        return callback(bean);
    }
    ...
    @ResponseBody
    public ResultBean edit(@Valid UserReportConfigFormRequest formRequest) {
        UserReportConfig bean = this.getUserEntity(UserReportConfig.class,formRequest.getId(),formRequest.getUserId());
        BeanCopy.copyProperties(formRequest,bean);
        ReportConfig reportConfig = reportService.getReportConfig(formRequest.getReportConfigId(),formRequest.getLevel());
        if(reportConfig==null){
            return callbackErrorCode(PmsErrorCode.USER_ENTITY_NOT_ALLOWED);
    ...
    @ResponseBody
    public ResultBean addOrEditRemind(@Valid UserReportRemindFormRequest formRequest) {
