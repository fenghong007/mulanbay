...
public class ReadingRecordFormRequest implements BindUser{
    ...
    private ReadingRecord.BookType bookType;

    @NotNull(message = "{validate.readingRecord.language.NotNull}")
    private ReadingRecord.Language language;
    // 重要等级(0-5)
    ...
    public ReadingRecord.BookType getBookType() {
        return bookType;
    }

    public void setBookType(ReadingRecord.BookType bookType) {
        this.bookType = bookType;
    }

    public ReadingRecord.Language getLanguage() {
        return language;
    }

    public void setLanguage(ReadingRecord.Language language) {
