...
public class NotifyConfigFormRequest {
    ...
    private NotifyConfig.NotifyType notifyType;
    ...
    public NotifyConfig.NotifyType getNotifyType() {
        return notifyType;
    }

    public void setNotifyType(NotifyConfig.NotifyType notifyType) {
