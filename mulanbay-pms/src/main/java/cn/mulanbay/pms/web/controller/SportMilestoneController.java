...
/**
 * Created by fenghong on 2017/8/9.
 * 运动里程碑
 */
@Controller
...
public class SportMilestoneController extends BaseController {
    ...
    public String list() {
        return "sport/sportMilestoneList";
    }
    ...
    @ResponseBody
    public ResultBean create(@Valid SportMilestoneFormRequest formRequest ) {
    ...
    @ResponseBody
    public ResultBean edit(@Valid SportMilestoneFormRequest formRequest) {
