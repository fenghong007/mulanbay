...
/**
 * Created by fenghong on 2017/2/9.
 */
public class ChartUtil {
     ...
     * @return
     */
    public static ChartCalandarData createChartCalandarData(String title, String legendOne,String unit, DateStatSearch sf, List list){
