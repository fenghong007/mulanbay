...
<%@ include file="/static/include/header.jsp"%>
	<script type="text/javascript" src="/static/js/mulanbay/userCalendar.js"></script>
...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div region="center" border="true" title="用户日历信息"
		...
		<div class="easyui-layout" id="subWrap"
					...
					<table cellpadding="5" class="tableForm" style="width: 100%;">
						<tr>
							...
							<td><input class="easyui-validatebox" type="text"
									   name="bussIdentityKey" style="width:160px;" /></td>
							<td>关键字:</td>
							<td><input class="easyui-validatebox" type="text"
			...
			<div region="center" border="true" title="用户日历列表" split="true"
			...
			<form id="ff" method="post">
				<table cellpadding="5" class="tableForm">
					<tr>
						<td>食物:</td>
						<td colspan=3>
							<input class="easyui-tagbox" name="foods" style="width:450px;height:30px" id="keywordsList"
