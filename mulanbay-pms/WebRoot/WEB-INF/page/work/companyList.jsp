...
<title>公司管理</title>
	...
	<script type="text/javascript" src="/static/js/mulanbay/company.js"></script>
	<script type="text/javascript" src="/static/js/mulanbay/operationLogCompare.js"></script>

</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div region="center" border="true" title="公司统计"
		...
		<div class="easyui-layout" id="subWrap"
			...
			<div region="center" border="true" title="公司列表" split="true"
	...
	<div id="eidt-window" title="公司信息" class="easyui-window"
		...
		<div class="yhdiv">
			<form id="ff" method="post">
				<table cellpadding="5" class="tableForm">
					...
					<tr>
						<td>入职日期:</td>
						<td><input class="easyui-datebox" name="entryDate" id="entryDate"
								   data-options="showSeconds:false" style="width:120px"></td>
					</tr>
					<tr>
						<td>离职日期:</td>
						<td><input class="easyui-datebox" name="quitDate" id="quitDate"
								   data-options="showSeconds:false" style="width:120px"></td>
					</tr>
					<tr>
						<td>工作天数:</td>
						<td><input class="easyui-numberspinner" type="text" id="days"
								   name="days" style="width:158px;" data-options="required:true,min:0,precision:0"/>
						</td>
					</tr>
					<tr>
						<td>备注:</td>
				...
				<div class="submitForm">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton"
					   icon="icon-info" onclick="showEditLogCompare('Company','id')">修改记录</a>
				</div>
			</form>
		</div>
	</div>
