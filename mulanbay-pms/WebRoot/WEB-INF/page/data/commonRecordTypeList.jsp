...
<title>通用记录类型</title>
	...
	<script type="text/javascript" src="/static/js/mulanbay/commonRecordType.js"></script>
	<script type="text/javascript" src="/static/js/mulanbay/operationLogCompare.js"></script>

</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div region="center" border="true" title="通用记录类型统计"
		...
		<div class="easyui-layout" id="subWrap"
			...
			<div region="center" border="true" title="通用记录类型列表" split="true"
	...
	<div id="eidt-window" title="通用记录类型信息" class="easyui-window"
			...
			<form id="ff" method="post">
				<table cellpadding="5" class="tableForm">
					...
					<tr>
						<td>加入年分析图表:</td>
						<td>
							<input name="yearStat" type="radio" class="easyui-validatebox" checked="checked" required="true" value="true" style="width:30px">是 &nbsp;&nbsp;
							<input name="yearStat" type="radio" class="easyui-validatebox" required="true" value="false" style="width:30px">否
						</td>
					</tr>
					<tr>
						<td>加入八小时外分析:</td>
						<td>
							<input name="overWorkStat" type="radio" class="easyui-validatebox" checked="checked" required="true" value="true" style="width:30px">是 &nbsp;&nbsp;
							<input name="overWorkStat" type="radio" class="easyui-validatebox" required="true" value="false" style="width:30px">否
						</td>
					</tr>
					<tr>
						<td>排序号:</td>
				...
				<div class="submitForm">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton"
					   icon="icon-info" onclick="showEditLogCompare('CommonRecordType','id')">修改记录</a>
				</div>
			</form>
		</div>
	</div>
