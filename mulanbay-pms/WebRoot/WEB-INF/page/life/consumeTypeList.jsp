...
<title>消费类型</title>
	...
	<script type="text/javascript" src="/static/js/mulanbay/consumeType.js"></script>
	<script type="text/javascript" src="/static/js/mulanbay/operationLogCompare.js"></script>

</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div region="center" border="true" title="消费类型"
		...
		<div class="easyui-layout" id="subWrap"
			...
			<div region="center" border="true" title="消费类型列表" split="true"
	...
	<div id="eidt-window" title="消费类型信息" class="easyui-window"
		...
		<div class="yhdiv">
			<form id="ff" method="post">
				...
				<div class="submitForm">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton"
					   icon="icon-info" onclick="showEditLogCompare('ConsumeType','id')">修改记录</a>
				</div>
			</form>
		</div>
	</div>
