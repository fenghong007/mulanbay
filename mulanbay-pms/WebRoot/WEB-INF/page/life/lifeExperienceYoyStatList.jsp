...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div region="center" border="true" title="人生经历同期对比"
						...
						<tr>
							...
							<td>
								<select class="easyui-combobox" name="types"
										multiple="true" multiline="true" multivalue="true" separator="," style="width:70px;height:23px">
...
<script type="text/javascript">
	...
	function getJsonData() {
		var vurl = '../lifeExperience/yoyStat';
