...
<title>图书分类</title>
	...
	<script type="text/javascript" src="/static/js/mulanbay/bookCategory.js"></script>
	<script type="text/javascript" src="/static/js/mulanbay/operationLogCompare.js"></script>

</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div region="center" border="true" title="图书分类管理"
		...
		<div class="easyui-layout" id="subWrap"
			...
			<div region="center" border="true" title="图书分类列表" split="true"
	...
	<div id="eidt-window" title="图书分类信息" class="easyui-window"
		...
		<div class="yhdiv">
			<form id="ff" method="post">
				...
				<div class="submitForm">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton"
					   icon="icon-info" onclick="showEditLogCompare('BookCategory','id')">修改记录</a>
				</div>
			</form>
		</div>
	</div>
