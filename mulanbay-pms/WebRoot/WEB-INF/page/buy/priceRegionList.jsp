...
<title>价格区间</title>
	...
	<script type="text/javascript" src="/static/js/mulanbay/priceRegion.js"></script>
</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div region="center" border="true" title="价格区间统计"
	...
	<div id="eidt-window" title="价格区间信息" class="easyui-window"
		...
		<div class="yhdiv">
			<form id="ff" method="post">
				<table cellpadding="5" class="tableForm">
					...
					<tr>
						...
						<td><input class="easyui-numberspinner" type="text"
								   name="minPrice" style="width:158px;" data-options="required:true,min:0,precision:2"/>
						</td>
					</tr>
					<tr>
						<td>价格上限:</td>
						<td><input class="easyui-numberspinner" type="text"
								   name="maxPrice" style="width:158px;" data-options="required:true,min:0,precision:2"/>
						</td>
					</tr>
					<tr>
						<td>排序号:</td>
				...
				<div class="submitForm">
					<a href="javascript:void(0)" class="easyui-linkbutton"
					   icon="icon-ok" onclick="saveData()">保存</a> <a
						href="javascript:void(0)" class="easyui-linkbutton"
