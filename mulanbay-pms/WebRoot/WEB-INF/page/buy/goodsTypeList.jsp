...
<title>商品类型</title>
	...
	<script type="text/javascript" src="/static/js/mulanbay/goodsType.js"></script>
	<script type="text/javascript" src="/static/js/mulanbay/operationLogCompare.js"></script>

</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div region="center" border="true" title="商品类型统计"
		...
		<div class="easyui-layout" id="subWrap"
			...
			<div region="center" border="true" title="商品类型列表" split="true"
	...
	<div id="eidt-window" title="商品类型信息" class="easyui-window"
			...
			<form id="ff" method="post">
				<table cellpadding="5" class="tableForm">
					...
					<tr>
						<td>行为名称:</td>
						<td><input class="easyui-validatebox" type="text"
								   name="behaviorName" style="width:158px;" />
						</td>
					</tr>
					<tr>
						<td>上级分类:</td>
						<td><input id="parentGoodsTypeList" class="easyui-combotree"
								   name="parent.id" style="width:160px;"
								   data-options="required:true" missingMessage="上级分类"></td>
					</tr>
					<tr>
						<td>状态:</td>
						<td>
				...
				<div class="submitForm">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton"
					   icon="icon-info" onclick="showEditLogCompare('GoodsType','id')">修改记录</a>
				</div>
			</form>
		</div>
	</div>
