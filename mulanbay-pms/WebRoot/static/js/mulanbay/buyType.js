...
function edit() {
	...
	var url='../buyType/get?id='+ rows[0].id;
	doAjax(null,url,'GET',false,function(data){
		$('#eidt-window').window('open');
        $('#ff').form('clear');
        initForm();
		$('#ff').form('load', data);
		$('#ff').form.url='../buyType/edit?id=' + data.id;
		//设置字符
...
function del() {
    var delUrlPrefix = '../buyType/delete';
